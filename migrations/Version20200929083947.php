 ...
 */
final class Version20200929083947 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_sheet (user_id INT NOT NULL, sheet_id INT NOT NULL, INDEX IDX_65FE6ABAA76ED395 (user_id), INDEX IDX_65FE6ABA8B1206A5 (sheet_id), PRIMARY KEY(user_id, sheet_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
